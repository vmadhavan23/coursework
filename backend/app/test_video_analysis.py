...
def test_api_ingests_summary_into_openrag_when_analyzable(client, monkeypatch):
    """REQ-029: a successful analysis is added to the OpenRAG index, best-effort."""
    from tests.test_openrag_integration import FakeOpenRAGClient
    ...
    assert video_url in instance.documents.calls[0]["content"]
